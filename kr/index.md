...
<section class="section document-entry-section" id="notes">
  <section class="home-document-group" aria-labelledby="essay-heading">
    <div class="home-section-heading">
      <p>ESSAYS</p>
      <h2 id="essay-heading">에세이</h2>
    </div>

    <div class="collection-grid">
      <a class="collection-card collection-card-essay" href="{{ "/kr/essays/debuggingless-development/" | relative_url }}">
      ...
      <a class="collection-card collection-card-essay" href="{{ "/kr/essays/otherwise/" | relative_url }}">
  ...
  <nav class="utility-link-row" aria-label="관리용 문서">
    ...
    <a class="utility-link utility-link-unity" href="{{ "/kr/csharp/semantic-layer-naming/" | relative_url }}">
      <span>NAMING</span>
