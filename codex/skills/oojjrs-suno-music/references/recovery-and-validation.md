...
7. obtain any required current authority or action-time confirmation.
...
2. reacquire the Suno tab from the existing Chrome binding;
...
- **Sign-in or reauthentication**: Ask the user to complete it in the selected Chrome window and report when ready.
- **CAPTCHA**: Ask whether the user wants it solved and follow the Chrome policy; never bypass it.
- **Microphone, upload, Voice, or identity check**: Obtain the exact confirmation or hand control to the user.
...
- **Rights or public-visibility warning**: Surface the exact consequence and wait for the appropriate confirmation.
