...
Verify only affected release surfaces: the package root and `package.json`, version-dependent manifest or lock entries, changed README install references, and expected companion `.meta` files. Never hand-create or hand-edit metadata; include only in-scope metadata generated by Unity through the official import/save path.
