...
9. Preserve the existing README language unless the user asks to change it. Validate only changed links, commands, code snippets, and factual claims against their live project sources.
